...
public class EntityNullsphere extends SkillEntity {
    public EntityNullsphere(World world) {
        super(world);
    }

    public EntityNullsphere(World worldIn, EntityLivingBase playerin, double skilldamage) {
