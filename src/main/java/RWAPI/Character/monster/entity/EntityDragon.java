                ...
                if(attackTicks % 60 == 0){
                    ...
                    for(Entity mi : mini) {
                        ...
                        if(mi instanceof EntityPlayerMP) {
                            ...
                            RWAPI.util.DamageSource.DamageSource dsource = RWAPI.util.DamageSource.DamageSource.causeUnknownMeleeMagic(this.getData(),target,this.getData().getAd()/2);
                            RWAPI.util.DamageSource.DamageSource dsource1 = RWAPI.util.DamageSource.DamageSource.causeUnknownMeleePhysics(this.getData(),target,this.getData().getAd()/2);
