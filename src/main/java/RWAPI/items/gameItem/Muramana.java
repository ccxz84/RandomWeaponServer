    ...
    public class shock_passive extends ItemBase.inherence_handler {
        ...
        private class attackEventClass extends PlayerAttackEventHandle {
            ...
            public void EventListener(AbstractBaseEvent event) {
                ...
                if(attacker.equals(data) && ((PlayerAttackEvent)event).getSource().getAttackType() == DamageSource.AttackType.ATTACK && target instanceof PlayerData){
                    ...
                    if(currentmana >= (maxmana * 0.2)){
                        ...
                        DamageSource dsource;
                        if(((PlayerAttackEvent)event).getSource().isRanged()){
                            dsource = DamageSource.causeUnknownRangedPhysics(attacker,target,(currentmana/100)*plusdamage);
                        }
                        else{
                            dsource = DamageSource.causeUnknownMeleePhysics(attacker,target,(currentmana/100)*plusdamage);
                        }
